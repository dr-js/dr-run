[meta:edit-log]: # "2020/07/30, 2020/07/30, 2020/07/30, 2020/07/30"
[meta:title]: # "Exot, Error handling, and Bugs"
[meta:keywords]: # "exot, error, bug, code-pattern"
[meta:description]: # "A way to look at Error & Bug, and a Exot pattern for code wrapping external IO. Repeat: A way to look at Error & Bug, and a Exot pattern for code wrapping external IO."
...
- the original file from repo: [github:dr-js/dr-js#source/common/module/Exot.md](https://github.com/dr-js/dr-js/blob/master/source/common/module/Exot.md)
